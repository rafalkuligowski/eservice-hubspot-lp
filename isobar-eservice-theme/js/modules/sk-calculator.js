const skCalculator = {
    init: function () {
        this.attachEvents();
        // setTimeout(() => {
            // console.log(document.querySelector('#newYearText'));
            this.elements.newYearText.classList.add('hidden');
        // }, 1500);
        this.packageOnChange();
    },
    elements: {
        ...
        newYearText: document.querySelector('#newYearText'),
    },
    packageOnChange: function () {
        document.querySelector('#skCalculatorPackage').addEventListener('change', (e) => {
            if(e.target.value == '1' || e.target.value == '2') {
                document.querySelector('#newYearText').classList.remove('hidden');
            } else {
                document.querySelector('#newYearText').classList.add('hidden');
            }
        });
    },
    ...
    methods: {
        ...
        countAndSet: function () {
            ...
            if (_self.methods.checkIfFilled()) {
                ...
                if (parseInt(document.querySelector('#skCalculatorTerminal').value) === 8 && _self.elements.earningForDealPositive) {
                ...
                } else if (_self.elements.earningForDealPositive) {
                ...
                if(pwI !== 1 && pwI !== 2) {
                    document.querySelector('#documentFillInstructions').classList.remove('hidden');
                    _self.methods.showDocument(packageName);
                } else {
                    document.querySelector('#documentFillInstructions').classList.add('hidden');
                }
